...
if(!class_exists('THWVSF_Admin')):
    ...
    public function output_review_request_link(){
        ...
        $now = time();
        $dismiss_life  = apply_filters('thwvsf_dismissed_review_request_notice_lifespan', 3 * MONTH_IN_SECONDS);
        $reminder_life = apply_filters('thwvsf_skip_review_request_notice_lifespan',  1 * DAY_IN_SECONDS);
    ...
    private function render_review_request_notice(){
        ...
        $remind_url  = $admin_url . '&thwvsf_remind=true&thwvsf_review_nonce=' . wp_create_nonce( 'thwvsf_notice_security');
        $dismiss_url = $admin_url . '&thwvsf_dismiss=true&thwvsf_review_nonce=' . wp_create_nonce( 'thwvsf_notice_security');
        $reviewed_url= $admin_url . '&thwvsf_reviewed=true&thwvsf_review_nonce=' . wp_create_nonce( 'thwvsf_notice_security');
        ?>
        <div id="thwvsf_review_request_notice" class="notice notice-info thpladmin-notice is-dismissible thwvsf-review-wrapper" data-nonce="<?php echo wp_create_nonce( 'thwvsf_notice_security'); ?>">
            ...
            <div class="thwvsf-review-content">
                <h3><?php esc_html_e('We are listening!', 'woocommerce-product-variation-swatches'); ?></h3>
                <p><?php  esc_html_e('We are waiting to know your experience using the plugin Woocommerce Variation Swatches. Tell us what you loved about the latest improvements. Also, drop in your suggestions, review and help us grow better.', 'product-variation-swatches-for-woocommerce'); ?></p>
                <div class="action-row">
                    <a class="thwvsf-notice-action thwvsf-yes" onclick="window.open('https://wordpress.org/support/plugin/product-variation-swatches-for-woocommerce/reviews/?rate=5#new-post', '_blank')" style="margin-right:16px; text-decoration: none">
                        <?php esc_html_e("Yes, today", 'product-variation-swatches-for-woocommerce'); ?>
                    </a>
